...
fn gen_lint_group_list<'a>(group_name: &str, lints: impl Iterator<Item = &'a Lint>) -> String {
    ...
    for (module, name, version) in details {
        if version.as_ref().map_or(false, |v| v == "nightly") {
            output.push_str(&format!(
                "    clippy_utils::nightly_lints::is_enable_nightly_lint().then_some(LintId::of({}::{})),\n",
                module, name
            ));
        } else {
...
fn gen_nightly_lint_list<'a>(
    ...
    let mut output = GENERATED_FILE_COMMENT.to_string();
    output.push_str("clippy_utils::nightly_lints::set_nightly_lints([\n");
    ...
    fn test_gen_lint_group_list() {
        ...
        let expected = GENERATED_FILE_COMMENT.to_string()
            + &[
                ...
                "    clippy_utils::nightly_lints::is_enable_nightly_lint().then_some(LintId::of(module_name::NIGHTLY_LINT)),",
