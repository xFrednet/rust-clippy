...
const DEFAUTL_DOCS_LINK: &str = "https://docs.rs/{krate}/{version}/src/{krate}/{file}.html#{line}";
const DEFAUTL_GITHUB_LINK: &str = "{url}/blob/{hash}/src/{file}#L{line}";
const DEFAUTL_PATH_LINK: &str = "{path}/src/{file}:{line}";
    ...
    for tk in tomlcrates {
        if let Some(ref path) = tk.path {
            crate_sources.push(CrateWithSource {
                ...
                file_link: tk.file_link(DEFAUTL_PATH_LINK),
            ...
            crate_sources.push(CrateWithSource {
                ...
                file_link: tk.file_link(DEFAUTL_DOCS_LINK),
                options: tk.options.clone(),
            });
            ...
            crate_sources.push(CrateWithSource {
                ...
                file_link: tk.file_link(DEFAUTL_GITHUB_LINK),
                options: tk.options.clone(),
            });
        } else {
